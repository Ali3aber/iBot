...
bot_token = "774852620:AAF9IAJMcyLy3Q6Hfw1fFy2VAY1yv9Nw2tM" --> رو که در بات فادر ساختین جایگزین کنید api اینجا توکن ربات
send_api = "https://api.telegram.org/bot"..bot_token
sudo_id = 300131107 --> اینجا آیدی سودو اصلی رو جایگزین کنید
MaTaDoRch = '@Alisaber313' --> یوزرنیم کانالتونو جایگزین کنید
MaTaDoRby = '@Remember_m_e' --> یوزرنیم سودو اصلی رو جایگزین کنید
require('./bot/methods')
require('./bot/utils')
require('./libs/JSON')
...
function create_config( )
  ...
  config = {
    ...
    sudo_users = {300131107,1062654880,774852620}, --> رو جایگزین کنید api و cli داخل آکولاد آیدی سودو اصلی و سودوهای دیگه (درصورت نیاز) و آیدی ربات
    admins = {},
    disabled_channels = {},
