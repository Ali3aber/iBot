...
---------------------------------------
if ((matches[1]:lower() == 'helplock' ) or (matches[1]:lower() == 'راهنمای قفل' )) and is_sudo(msg) then
local helpen = _help and _help.helpen
local helpfa = _help and _help.helpfa
...
---------------------------------------
if ((matches[1]:lower() == 'helpmod' ) or (matches[1]:lower() == 'راهنمای مدیریت' )) and is_sudo(msg) then
local helpen = _help and _help.helpen
local helpfa = _help and _help.helpfa
...
---------------------------------------
if ((matches[1]:lower() == 'helpclean' ) or (matches[1]:lower() == 'راهنمای پاکسازی' )) and is_sudo(msg) then
local helpen = _help and _help.helpen
local helpfa = _help and _help.helpfa
