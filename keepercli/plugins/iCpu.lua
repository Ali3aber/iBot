...
if not lang then
 return "*>Lσcк Ʋιɗєσ Self* `Iѕ AƖяєαɗу ƐηαвƖєɗ` ♻️⚠️"
elseif lang then
...
save_data(_config.moderation.data, data)
if not lang then 
 return "*>Lσcк Ʋιɗєσ Self* `Hαѕ Ɓєєη ƐηαвƖєɗ` 🤖🔇\n*OяɗєяƁу :* [@"..check_markdown(msg.from.username or '').."*|*`"..msg.from.id.."`]"
else
...
if not lang then
return "*>Lσcк Ʋιɗєσ Self* `Iѕ AƖяєαɗу ƊιѕαвƖєɗ` ❌🔐" 
elseif lang then
...
data[tostring(target)]["mutes"]["mute_video_self"] = 'no'
 save_data(_config.moderation.data, data) 
if not lang then
return "*>Lσcк Ʋιɗєσ Self* `Hαѕ Ɓєєη ƊιѕαвƖєɗ` 🤖🔊\n*OяɗєяƁу :* [@"..check_markdown(msg.from.username or '').."*|*`"..msg.from.id.."`]" 
else
