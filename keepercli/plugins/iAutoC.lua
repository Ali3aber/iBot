...
redis:setex("atoc"..msg.chat_id_..msg.sender_user_id_,45,true)
if redis:get("atoc1"..msg.chat_id_) and redis:get("atoc2"..msg.chat_id_) then
redis:del("atoc1"..msg.chat_id_)
redis:del("atoc2"..msg.chat_id_)
redis:del("c_ato:"..msg.chat_id_)
...
redis:del("atoc"..msg.chat_id_..msg.sender_user_id_)
redis:setex("atoc1"..msg.chat_id_,45,matches[1]..':'..matches[2])
redis:setex("atoc2"..msg.chat_id_..msg.sender_user_id_,45,true)
...
local time_1 = redis:get("atoc1"..msg.chat_id_)
...
redis:set("atoc1"..msg.chat_id_,redis:get("atoc1"..msg.chat_id_))
redis:set("atoc2"..msg.chat_id_,matches[1]..':'..matches[2])
...
if redis:get("atoc2"..msg.chat_id_) or redis:get("atoc2"..msg.chat_id_) then
local time = os.date("%H%M")
local time2 = redis:get("atoc1"..msg.chat_id_)
time2 = time2.gsub(time2,":","")
local time3 = redis:get("atoc2"..msg.chat_id_)
time3 = time3.gsub(time3,":","")
if tonumber(time3) < tonumber(time2) then
if tonumber(time) <= 2359 and tonumber(time) >= tonumber(time2) then
if not redis:get("c_ato:"..msg.chat_id_) then
redis:set("c_ato:"..msg.chat_id_,true)
tdcli.sendMessage(msg.chat_id_, 0, 1, 'پاکسازی خودکار ربات فعال شد\nگروه تا ساعت *'..redis:get("atoc2"..msg.chat_id_)..'!rmsgall', 1, 'md')
end
...
if redis:get("c_ato:"..msg.chat_id_) then
redis:del("c_ato:"..msg.chat_id_, true)
end
end
...
tdcli.sendMessage(msg.chat_id_, 0, 1, '!rmsgall'..redis:get("atoc2"..msg.chat_id_)..'!rmsgall')
end
end
end
end
