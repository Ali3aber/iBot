...
chats = {}
plugins = {}
MaTaDoR_sudo = 300131107 --> اینجا آیدی سودو اصلی رو جایگزین کنید
GpsidSudo = -300131107 --> اینجا آیدی پیوی یا گروه یا حتی چنل مورد نظرتونو جایگزین کنید تا هرجا ربات نصب میشه پیام اطلاع رسانی نصب در گروه جدید رو اینجا بده
bot_id =  1062654880 --> جایگزین کنید cli اینجام که آیدی ربات
helper_id =  774852620--> جایگزین کنید api آیدی ربات
MaTaDoRch = '@Alisaber313' --> یوزرنیم کانالتونو جایگزین کنید
MaTaDoRby = '@Remember_M_e' --> یوزرنیم خودتونو جایگزین کنید
MaTaDoRbybot = '@alisaber313'  --> اگه پیام رسان دارید یوزرنیم پیام رسانتو جایگزین کنید 
